...
class OfficialSignIn extends React.Component{
    handleClick(e){
        e.preventDefault();
        ...
        this.props.dispatch(actionCreator.fetchVendor(document.getElementById("vendorid").value)).then(()=>{
            this.props.history.push("/supplysecondpage/unlogin/public");
        })}
    ...
    render(){
        return(
            <div>
                <button className="btn btn-light mx-3 mt-3 backbutton" onClick={this.moveBack.bind(this)}><span><i className="material-icons backbtn">arrow_back</i></span></button>
...
export default connect(mapStateToProps)(OfficialSignIn);